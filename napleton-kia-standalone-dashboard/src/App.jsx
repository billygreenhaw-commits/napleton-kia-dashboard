  ...
  return (
    <aside className="executive-sidebar">
      <div className="sidebar-logo-panel">
        <div className="kia-silver">KIA</div>
      ...
      <nav className="sidebar-nav">
        {nav.map(([Icon, label], index) => (
          <a key={label} className={`sidebar-nav-item ${index === 0 ? 'active' : ''}`} href="#">
            <Icon size={18} />
            <span>{label}</span>
          </a>
        ))}
  ...
  return <div className="executive-shell">
    ...
    <div className="executive-main">
      <header className="executive-header">
        <div>
          <h1>Napleton Kia Mid Rivers</h1>
          <div className="executive-subtitle">Service Performance Command Center</div>
        </div>
        ...
        <div className="header-actions">
          ...
          <button className="btn import-btn" onClick={()=>csiFileRef.current?.click()}><Upload size={14}/> CSI</button>
          <button className="btn import-btn secondary" onClick={()=>dispositionFileRef.current?.click()}><Upload size={14}/> Disposition</button>
          <button className="btn import-btn followup" onClick={()=>followUpFileRef.current?.click()}><Upload size={14}/> Follow-Up</button>
        </div>
      </header>

      {importStatus && <div className="import-banner">{importStatus}</div>}
